	...
	<section class="mb-10">
		<header class="mb-10">
			...
			<p class="text-accent mb-4 text-base leading-relaxed">
				Here are some projects I'm particularly proud of, along with projects
				I've contributed to. Many are open-source – take a look at the code and
		...
		<div class="mb-4 flex flex-row flex-wrap gap-4">
			{#each filters as { key, label } (key)}
				<button
					...
					class="border-elevation-one hover:border-primary rounded border px-2 py-1 text-sm font-semibold duration-300 hover:scale-105"
