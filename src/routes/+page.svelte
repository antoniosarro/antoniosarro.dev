<script lang="ts">
	...
	} from '$lib/components/home/contributions';
...
<main class="mx-auto mt-20 max-w-7xl px-6 md:px-16 lg:mt-32">
	<section
		...
		<div class="max-w-2xl lg:max-w-2xl">
			<h1
				class=" font-incognito mb-6 min-w-full text-3xl font-semibold tracking-tight sm:text-5xl lg:min-w-[700px] lg:leading-[3.7rem]">
			...
			<div class="flex flex-col gap-2 text-justify">
				<p class="text-accent text-base leading-relaxed">
					Hi, I'm <span class="text-primary font-semibold">Antonio</span>
					, {calculateAge(new Date('1999-11-16'))}-year-old software engineer
					with a lifelong
				...
				<p class="text-accent text-base leading-relaxed">
					...
					<span class="text-primary font-semibold">Italy</span>
					and enjoy the continuous pursuit of self-improvement.
				</p>
			</div>
			<Socials />
		</div>
	...
	<section class="mb-10 flex flex-col gap-4">
		<h2 class="font-incognito text-4xl font-bold tracking-tight">
			Contribution Graph
		</h2>
		{#await contributions}
			<ContributionsSkeleton />
	...
	<section id="projects" class="mb-10 flex flex-col gap-4">
		...
		<div class="ml-auto">
			<a
				...
				class="border-elevation-one bg-primary text-background flex items-center justify-center gap-1 rounded-md border px-2 py-1 text-base">
