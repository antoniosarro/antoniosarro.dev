...
<footer class="relative mt-10 min-h-full border-t border-elevation-one md:mt-28">
	<div
	...
	>
		...
		<div class="flex flex-col items-center gap-2 text-center lg:items-end lg:text-end">
			<div class="flex items-center gap-2 text-sm">
				<a
					href="/changelog"
					class="font-mono text-primary duration-200 hover:underline"
				...
				{#if versionInfo.commitHash !== 'development'}
					<a
						...
						class="flex items-center gap-1 font-mono text-accent duration-200 hover:text-primary"
				...
				{:else}
					<span class="font-mono text-accent" title="Development build">
						{versionInfo.commitHashShort}
					</span>
				{/if}
			</div>
